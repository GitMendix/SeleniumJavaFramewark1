...
public class Login_Ng4 {
  ...
  public void setUp() throws Exception {
	  ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Users\\alok.gupta\\Desktop\\Mercury\\LoginextentReports4.html");
  ...
  public void testNegative() throws Exception {
	  ExtentTest test= extent.createTest("Mendix Application Login","Mendix  Login Condition verify for : Field min Length");
 ...
 test.pass("NAvigated to login page");
    ...
    driver.findElement(By.cssSelector("#usernameInput")).sendKeys("AD");
    driver.findElement(By.cssSelector("#passwordInput")).clear();
    driver.findElement(By.cssSelector("#passwordInput")).sendKeys("Men");
   ...
   // String passvalue=driver.findElement(By.cssSelector("#usernameInput")).getAttribute("#usernameInput");
    ...
    System.out.println("Condition verify for : Field min Length");
