...
public class Login_Ng6 {
  ...
  public void setUp() throws Exception {
	  ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Users\\alok.gupta\\Desktop\\Mercury\\LoginextentReports6.html");
  ...
  public void testNegative() throws Exception {
	  ExtentTest test= extent.createTest("Mendix Application Login","Mendix  Login Condition verify for : Old Password");
   ...
   // String passvalue=driver.findElement(By.cssSelector("#usernameInput")).getAttribute("#usernameInput");
    ...
    System.out.println("Condition verify for : Old Password"); 
   }
